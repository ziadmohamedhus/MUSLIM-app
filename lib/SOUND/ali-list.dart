...
class ali_list extends StatelessWidget {
  String v='https://ia600406.us.archive.org/17/items/AliJaber_722/';
  List ali=[
    '001.mp3',
    '002.mp3',
    '003.mp3',
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    CircleAvatar(
                      ...
                      backgroundImage: AssetImage('assets/image/j.jpg'),
                      radius: 25.0,
                    )
                  ],
                ),
              ...
              for(int i=0;i<list_2.length;i++)
                Card(
                  ...
                  child: ListTile(
                    ...
                    onTap: (){Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context)=> MyHomePage2(v+ali[i])));},
                  ),
                ),
            ],
          ),
