...
class Hosary_list extends StatelessWidget {
  String v='https://server13.mp3quran.net/husr/';
  List h=[
    '001.mp3',
    '002.mp3',
    '003.mp3',
              ...
              for(int i=0;i<list_2.length;i++)
                Card(
                  ...
                  child: ListTile(
                    ...
                    onTap: (){Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context)=> MyHomePage2(v+h[i])));},
                  ),
                ),
            ],
          ),
