...
class MenShawy_list extends StatelessWidget {

  String v='https://server10.mp3quran.net/minsh/';
  List m=[
    '001.mp3',
    '002.mp3',
    '003.mp3',
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    CircleAvatar(
                      ...
                      backgroundImage: AssetImage('assets/image/m.jpg'),
                      radius: 25.0,
                    )
                  ],
                ),
              ...
              for(int i=0;i<list_2.length;i++)
                Card(
                  ...
                  child: ListTile(
                    ...
                    onTap: (){Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context)=> MyHomePage2(v+m[i])));},
                  ),
                ),
            ],
          ),
